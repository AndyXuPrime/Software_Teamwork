...
## Session 4: Knowledge MCP tool schemas

**Date**: 2026-07-03
**Task**: Knowledge MCP tool schemas
**Branch**: `Special/docs/knowledge-mcp-tool-schemas`

### Summary

Defined field-level schemas, limits, output contracts, examples, errors, and Agent selection rules for all four Knowledge MCP tools.
